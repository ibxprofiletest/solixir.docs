  ...
  [5337],
  {
    4093: (f, e, d) => {
      ...
      var t = d(54568),
        ...
        b = d(5047),
        o = d(54217);
      let i = (0, c.createContext)({ open: !1, setOpen: () => {} });
      function s(f) {
        let {
            button: e,
            children: d,
        ...
        return (0, t.jsx)(i.Provider, {
          value: { open: h, setOpen: m },
          children: (0, t.jsxs)(a.bL, {
            modal: !1,
            open: h,
            onOpenChange: m,
            children: [
      ...
      function u(f) {
        let { children: e, className: d } = f;
        return (0, t.jsxs)("div", {
          className: (0, n.P)("group/dropdown", "flex", "items-center", d),
      ...
      function p(f) {
        let {
          ...
          l = (0, n.P)(
            ...
            f.disabled ? "opacity-7 cursor-not-allowed" : "cursor-pointer",
            c
          );
        return r
          ? (0, t.jsx)(a.q7, {
          ...
          : (0, t.jsx)(a.q7, {
              ...s,
              className: (0, n.P)("px-3 py-1", l, c),
              children: e,
            });
      }
      function m(f) {
        let { children: e, label: d } = f;
        return (0, t.jsxs)(a.Pb, {
          children: [
            (0, t.jsxs)(a.ZP, {
              className:
                "flex cursor-pointer items-center justify-between rounded-sm straight-corners:rounded-xs px-3 py-1 text-sm focus:outline-hidden data-highlighted:bg-tint-hover",
              children: [
                d,
                (0, t.jsx)(r.In, {
                  icon: "chevron-right",
                  className: "size-3 shrink-0 opacity-6",
                }),
              ],
            }),
            (0, t.jsx)(a.ZL, {
              children: (0, t.jsx)(a.G5, {
                hideWhenDetached: !0,
                collisionPadding: 8,
                className: "z-40 animate-present",
                children: (0, t.jsx)("div", {
                  className:
                    "flex max-h-96 min-w-40 max-w-[40vw] flex-col gap-1 overflow-auto rounded-lg straight-corners:rounded-sm bg-tint-base p-2 shadow-lg ring-1 ring-tint-subtle sm:min-w-52 sm:max-w-80",
                  children: e,
                }),
              }),
            }),
      ...
      function h(f) {
        ...
        return (0, t.jsx)(a.wv, {
          className: (0, n.P)(
            "my-1 h-px w-full border-tint-subtle border-t",
            e
          ),
        });
      }
      function g() {
        let f = (0, c.useContext)(i);
        return (
          (0, b.assert)(f, "DropdownMenuContext not found"),
          (0, c.useCallback)(() => f.setOpen(!1), [f])
        );
      }
    },
    5384: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { Tooltip: () => n });
      var t = d(54568),
        r = d(98743),
        c = d(87586);
      function n(f) {
        ...
        return (0, t.jsxs)(c.bL, {
          delayDuration: 300,
          ...b,
          children: [
            (0, t.jsx)(c.l9, { asChild: !0, ...n, children: e }),
            (0, t.jsx)(c.ZL, {
              children: (0, t.jsxs)(c.UC, {
                sideOffset: 4,
                className: (0, r.P)(
    ...
    5833: (f, e, d) => {
      ...
      async function o(f, e) {
        if ((0, r.isCookiesTrackingDisabled)() || !e) return (0, c.M)();
        let d = (0, t.dJ)("__session");
        if (d) return d;
        let n = (0, c.M)(),
          a = new URL(f);
        (a.pathname = "/__session/2/"), a.searchParams.set("proposed", n);
        try {
          let f = await fetch(a, {
              method: "GET",
              credentials: "include",
            ...
            { deviceId: e } = await f.json();
          return e;
        } catch (f) {
          return console.error("Failed to fetch visitor session ID", f), n;
        }
      }
    },
    14417: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { InsightsProvider: () => m, useTrackEvent: () => h });
      var t = d(54568),
        r = d(69804),
        c = d(7620),
        n = d(60357),
      ...
      function m(f) {
        let {
            enabled: e,
            children: d,
            visitorCookieTrackingEnabled: m,
            eventUrl: h,
            appURL: g,
          } = f,
          v = (0, b.uT)(),
            ...
            let f = (function () {
                ...
                try {
                  ...
                  if (
                    ...
                    "object" == typeof f &&
                    "lastActiveAt" in f &&
                    "number" == typeof f.lastActiveAt &&
                    "id" in f &&
                    "string" == typeof f.id &&
                    f.lastActiveAt + 18e5 > Date.now()
                  )
                    return (i = f) && ((i.lastActiveAt = Date.now()), l()), i;
                } catch (f) {
                  console.error("Error parsing session", f);
                }
                return (
                  (i = { id: (0, o.M)(), lastActiveAt: Date.now() }), l(), i
                );
              })(),
              d = x.current;
            if (!d)
              throw Error("Visitor ID should be set before flushing events");
            let t = [];
            for (let e in y.current) {
              let r = y.current[e];
              r &&
                r.events.length &&
                r.pageContext &&
                (t.push(
                  ...(function (f) {
                    ...
                    let r = {
                        ...
                        visitorAuthClaims: f.context.visitorAuthClaims,
                      },
                      c = {
                        url: f.url,
                        siteSection:
                          null != (e = f.context.siteSectionId) ? e : null,
                        siteSpace:
                          null != (d = f.context.siteSpaceId) ? d : null,
                        space: f.context.spaceId,
                        siteShareKey:
                          null != (t = f.context.siteShareKey) ? t : null,
                        revision: f.context.revisionId,
                        page: f.pageContext.pageId,
                        displayContext: f.pageContext.displayContext,
                      };
                    return f.events.map((f) => ({
                      ...f,
                      session: r,
                      location: c,
                    }));
                ...
                (y.current[e] = { ...r, events: [] }));
            }
            t.length > 0 &&
              e &&
              (function (f) {
                let { eventUrl: e, events: d } = f;
                fetch(e, {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  keepalive: !0,
                  body: JSON.stringify({ events: d }),
                }).catch((f) => {
                  console.error("Error sending events", f);
                });
              })({ eventUrl: h, events: t });
          }),
          k = (0, n._6)(async () => {
            var f;
            let e =
              null != (f = x.current) ? f : await (0, u.getVisitorId)(g, m);
            (x.current = e), w();
          }, 1500),
          j = (0, n.DK)((f, e, d) => {
            var t, r, c;
            ...
            (y.current[n] = {
              pageContext:
                null != (t = null == a ? void 0 : a.pageContext) ? t : e,
              url:
                null != (r = null == a ? void 0 : a.url)
                  ? r
                  : window.location.href,
              events: [
                ...(null != (c = null == a ? void 0 : a.events) ? c : []),
                { ...f, timestamp: new Date().toISOString() },
              ],
              context: v,
            }),
              void 0 !== y.current[n].pageContext &&
                ((null == d ? void 0 : d.immediate) && x.current
                  ? (k.cancel(), w())
                  : k());
          });
        return (
          c.useEffect(
            () => (
              (0, u.getVisitorId)(g, m).then((f) => {
                (x.current = f), window.addEventListener("beforeunload", w);
              }),
              () => {
          ...
          (0, t.jsx)(p.Provider, {
            value: j,
            children: (0, t.jsx)(r.OpenAPIOperationContextProvider, {
              onOpenClient: (f) => {
                j({ type: "api_client_open", operation: f });
              },
              children: d,
            }),
          })
      ...
      function h() {
        return c.useContext(p);
      }
    },
    15200: (f) => {
      f.exports = {
        zoomModal: "ZoomImage_zoomModal__VzJS3",
        zoomImg: "ZoomImage_zoomImg__teSyL",
        zoomImageActive: "ZoomImage_zoomImageActive__C33dt",
      };
    },
    15943: (f, e, d) => {
      "use strict";
      d.r(e),
        d.d(e, {
          LoadingStateProvider: () => n,
          SuspenseLoadedHint: () => b,
          useBodyLoaded: () => a,
        });
      var t = d(54568),
        r = d(7620);
      let c = (0, r.createContext)({ bodyLoaded: !1, setBodyLoaded: () => {} });
      function n(f) {
        let { children: e } = f,
          [d, n] = (0, r.useState)(!1),
          a = (0, r.useMemo)(() => d, [d]);
        return (0, t.jsx)(c.Provider, {
          value: { bodyLoaded: a, setBodyLoaded: n },
          children: e,
        });
      }
      function a() {
        let f = (0, r.useContext)(c);
        return (0, r.useMemo)(() => f.bodyLoaded, [f.bodyLoaded]);
      }
      function b() {
        let f = (0, r.useContext)(c);
        return (
    ...
    18003: (f, e, d) => {
      ...
      var t = d(54568),
        r = d(7620),
        c = d(50273);
      let n = r.createContext({ iconStyle: c.p.Regular });
      function a(f) {
        let e = r.useContext(n),
          {
            children: d,
            assetsURL: c = e.assetsURL,
            assetsURLToken: a = e.assetsURLToken,
            iconStyle: b = e.iconStyle,
            assetsByStyles: o = e.assetsByStyles,
          } = f,
          i = r.useMemo(
            () => ({
              assetsURL: c,
        ...
        return (0, t.jsx)(n.Provider, { value: i, children: d });
      }
      function b() {
      ...
      function o(f, e) {
        if (!f.assetsURL)
          throw Error("You first need to pass a assetsURL to <IconsProvider>");
        let d = ""
          .concat(
            f.assetsURL + (f.assetsURL.endsWith("/") ? "" : "/") + e,
            "?v="
          )
          .concat(2);
        if (f.assetsURLToken) {
          let e = new URL(d);
          return e.searchParams.set("token", f.assetsURLToken), e.toString();
        }
        return d;
      }
      function i(f, e, d) {
        var t, r;
        return o(
          null != (r = null == (t = f.assetsByStyles) ? void 0 : t[e]) ? r : f,
          "svgs/".concat(e, "/").concat(d, ".svg")
        );
      }
    },
    19317: (f, e, d) => {
      "use strict";
      d.d(e, { AA: () => c, NU: () => r, Q1: () => t });
      let t = "@gitbook/announcement",
        r = "announcement-hidden",
        c = 7;
    },
    20255: (f, e, d) => {
      "use strict";
      ...
      function s(f) {
        ...
        return URL.canParse
          ? !!URL.canParse(f) && (!e || new URL(f).origin !== e)
          : f.startsWith("http");
      }
      var l = d(52288);
      let u = n.createContext({ externalLinksTarget: b.nS.Self });
      function p(f, e) {
        var d, t;
        let r =
            null != (d = f.target)
              ? d
              : e.isExternal && e.externalLinksTarget === b.nS.Blank
              ? "_blank"
              : void 0,
          c =
            null != (t = f.rel)
              ...
              ? "noopener noreferrer"
              : void 0;
        return { target: r, rel: c };
      }
      let m = n.forwardRef(function (f, e) {
          let {
              href: d,
              prefetch: r,
              children: b,
            ...
            { externalLinksTarget: x } = n.useContext(u),
            { updateHashFromUrl: y } = n.useContext(i.GK),
            w = (0, o.jt)(),
            k = (0, l.K)(h || []),
            j = s(d),
            { target: C, rel: P } = p(f, {
              externalLinksTarget: x,
              isExternal: j,
            }),
            _ = (e) => {
              var t;
              let r = s(d, window.location.origin);
              if (
                (j || y(d),
                m && w(m, void 0, { immediate: r }),
                window.self !== window.top && r)
              )
                e.preventDefault(),
                  window.open(d, "_blank", "noopener noreferrer");
              else if (j && !e.ctrlKey && !e.metaKey) {
                let { target: t = "_self" } = p(f, {
                  externalLinksTarget: x,
                  isExternal: r,
                });
                e.preventDefault(), window.open(d, t, P);
              }
              null == (t = v.onClick) || t.call(v, e);
            };
          return j
            ? (0, t.jsx)("a", {
                ref: e,
        ...
        h = n.forwardRef(function (f, e) {
          let { children: d, className: r, classNames: c, ...n } = f,
            b = (0, l.K)(c || []);
          return (0,
          t.jsx)("div", { ref: e, ...n, className: (0, a.P)("elevate-link relative", r, b), children: d });
        }),
        g = n.forwardRef(function (f, e) {
          let { children: d, className: r, ...c } = f;
          return (0,
          t.jsx)(m, { ref: e, ...c, className: (0, a.P)("link-overlay absolute inset-0 z-10", r), children: d });
        });
    },
    21520: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { useNow: () => r });
      var t = d(7620);
      function r() {
        let f =
    ...
    22159: (f, e, d) => {
      ...
      var t = d(54568),
        r = d(98743);
      let c = (f) => {
        let { style: e, tile: d, pulse: c, delay: n, gridStyle: a } = f,
          b = (() => {
            switch (n) {
              case 0:
                return "delay-0";
    ...
    24578: (f, e, d) => {
      "use strict";
      d.d(e, {
        $7: () => r.isCookiesTrackingDisabled,
        ax: () => c.TrackPageViewEvent,
        jt: () => t.useTrackEvent,
        nC: () => r.setCookiesTracking,
      });
      var t = d(14417);
      d(5833);
      var r = d(42613),
    ...
    28821: (f, e, d) => {
      ...
      function r(f) {
        return (
          f instanceof Error &&
          ("SecurityError" === f.name ||
            "NS_ERROR_FAILURE" === f.name ||
            "NS_ERROR_ABORT" === f.name)
        );
      }
      function c() {
      ...
      function b(f, e) {
        try {
          if (
            ...
            let d = localStorage.getItem(f);
            return d ? JSON.parse(d) : e;
          }
          return e;
        } catch (f) {
          if (r(f)) return e;
    ...
    31417: (f, e, d) => {
      "use strict";
      function t() {
        for (var f = arguments.length, e = Array(f), d = 0; d < f; d++)
          e[d] = arguments[d];
    ...
    33591: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { AnnouncementDismissedScript: () => a });
      var t = d(54568),
        r = d(7620),
        c = d(19317);
      function n(f, e, d) {
        ...
        try {
          let d = window.localStorage.getItem(f),
            r = d ? JSON.parse(d) : void 0;
          if (r && !r.visible) {
            let f = r.at,
              d = new Date().getTime();
            Math.floor((d - f) / 864e5) < e && (t = !1);
          }
        } catch (f) {}
        t || document.documentElement.classList.add(d);
      }
      function a() {
        let f = JSON.stringify([c.Q1, c.AA, c.NU]).slice(1, -1);
        return (
          r.useEffect(() => {
            n(c.Q1, c.AA, c.NU);
          }, []),
          (0, t.jsx)("script", {
            ...
            dangerouslySetInnerHTML: {
              __html: "(".concat(n.toString(), ")(").concat(f, ")"),
            },
          })
        );
      }
      ...
      function r(f, e) {
        ...
        (0, t.useLayoutEffect)(() => {
          ...
          (0, t.useEffect)(() => {
            ...
            return (
              f.addEventListener("scroll", r, { passive: !0 }),
              () => {
    ...
    42296: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { Checkbox: () => b });
      var t = d(54568),
        r = d(86424),
        c = d(23180),
        n = d(7620),
        a = d(98743);
      let b = n.forwardRef((f, e) => {
        let { className: d, size: n = "medium", ...b } = f;
        return (0, t.jsx)(c.bL, {
          ref: e,
          className: (0, a.P)(
            "peer",
            ...
            { small: "size-4", medium: "size-5" }[n],
            d
          ),
          ...b,
          children: (0, t.jsx)(c.C1, {
            className: "relative text-current",
            children: b.checked
              ? (0, t.jsx)(r.In, {
                  icon: "check",
                  iconStyle: r.pO.Solid,
                  className: "size-3",
                })
              : null,
          }),
      ...
      b.displayName = c.bL.displayName;
    },
    42613: (f, e, d) => {
      "use strict";
      d.r(e),
        d.d(e, {
          isCookiesTrackingDisabled: () => n,
          setCookiesTracking: () => c,
        });
      var t = d(28821);
      let r = "__gitbook_cookie_granted";
      function c(f) {
        (0, t.lz)(r, f ? "yes" : "no", {
          expires: 365,
          sameSite: "none",
      ...
      function n() {
        let f = (0, t.dJ)(r);
        return "yes" !== f && ("no" === f || void 0);
      }
    },
    47091: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { DateRelative: () => n });
      var t = d(54568),
        r = d(7620),
        c = d(88118);
      function n(f) {
        ...
        return (0, t.jsx)("time", {
          ...
          suppressHydrationWarning: !0,
          dateTime: e,
          title: b.toLocaleString(),
          children: (function (f, e) {
            if (
              "undefined" == typeof Intl ||
              void 0 === Intl.RelativeTimeFormat
            ) {
              let f = Math.floor(e / 24 / 60 / 60 / 1e3);
              return "".concat(f, " days ago");
            }
            let d = new Intl.RelativeTimeFormat(f, { style: "long" });
            if (e < 36e5) {
              let f = Math.floor(e / 60 / 1e3);
              return d.format(-f, "minute");
            }
            if (e < 864e5) {
              let f = Math.floor(e / 60 / 60 / 1e3);
              return d.format(-f, "hour");
            }
            if (e < 2592e6) {
              let f = Math.floor(e / 24 / 60 / 60 / 1e3);
              return d.format(-f, "day");
            }
            if (e < 31536e6) {
              let f = Math.floor(e / 30 / 24 / 60 / 60 / 1e3);
              return d.format(-f, "month");
            }
            let t = Math.floor(e / 365 / 24 / 60 / 60 / 1e3);
            return d.format(-t, "year");
          })(d.locale, o),
        });
      }
    },
    50273: (f, e, d) => {
      ...
      d.d(e, { p: () => t }),
        (function (f) {
          (f.Regular = "regular"),
            (f.SharpRegular = "sharp-regular"),
            (f.Solid = "solid"),
            (f.SharpSolid = "sharp-solid"),
            (f.Duotone = "duotone"),
            (f.SharpDuotoneSolid = "sharp-duotone-solid"),
            (f.Light = "light"),
            (f.SharpLight = "sharp-light"),
            (f.Thin = "thin"),
            (f.SharpThin = "sharp-thin");
        })(t || (t = {}));
    },
    52288: (f, e, d) => {
      "use strict";
    ...
    54217: (f, e, d) => {
      ...
      d.d(e, {
        ...
        e2: () => t.ButtonGroup,
        rI: () => m.DropdownMenu,
        _2: () => m.DropdownMenuItem,
        zT: () => i,
        jc: () => p.HoverCard,
        z8: () => p.HoverCardRoot,
        d0: () => p.HoverCardTrigger,
        N_: () => a.Link,
        PA: () => a.LinkSettingsContext,
        Rh: () => n,
        AM: () => l,
        ah: () => b,
        rz: () => u.useBodyLoaded,
      ...
      var a = d(20255);
      function b(f) {
        let { classNames: e, ...d } = f,
          t = [...(e || []), "LinkStyles"];
        return (0, r.jsx)(a.Link, {
          ...d,
          classNames: t,
          children: f.children,
        });
      ...
      function i(f) {
        let { code: e, style: d } = f,
          t = (function (f) {
            var e;
            if (!f) return "";
            let d = (null != (e = o[(f = f.toLowerCase())]) ? e : f)
              .split("-")
      ...
      function l(f) {
        ...
        return (0, r.jsxs)(s.Root, {
          ...a,
          children: [
            (0, r.jsx)(s.Trigger, { ...b, children: t }),
            (0, r.jsx)(s.Portal, {
              children: (0, r.jsxs)(s.Content, {
                ...o,
                collisionPadding:
                  null != (e = null == o ? void 0 : o.collisionPadding)
                    ? e
                    : 16,
                sideOffset:
                  null != (d = null == o ? void 0 : o.sideOffset) ? d : 4,
                className: (0, c.P)(
                ...
                style: { ...(null == o ? void 0 : o.style) },
                children: [
                  n,
                  i &&
                    (0, r.jsx)(s.Arrow, {
                      className:
                        "-mb-px h-2 w-4 fill-tint-3 stroke-2 stroke-tint-7",
                    }),
                ],
              }),
            }),
    ...
    54907: (f, e, d) => {
      ...
      function t() {
        return "undefined" != typeof crypto && crypto.randomUUID
          ? "".concat(crypto.randomUUID(), "R")
          : "".concat(Math.random().toString(36).substring(2), "R");
      }
      d.d(e, { M: () => t });
    },
    56240: (f, e, d) => {
            ...
            d =
              "undefined" != typeof ResizeObserver
                ? new ResizeObserver((f) => {
                    let d = f[0];
                    d &&
                      0 !== d.contentRect.width &&
                      ((e = d.contentRect.width), x(d.contentRect), t());
                  })
                : null,
            t = () => {
              let t = window.innerWidth - 64;
              e >= t || (d && f && e && f <= e) ? i(!1) : i(!0);
            };
          return (
            c.current && (null == d || d.observe(c.current)),
            d || t(),
            () => {
              null == d || d.disconnect();
            }
          ...
          children: h
            ...
            : (0, t.jsx)("img", {
                ...
                className: n()(
                  f.className,
                  o ? s().zoomImg : null,
                  l ? s().zoomImageActive : null
                ),
              }),
        });
      }
      function u(f) {
        let { src: e, alt: d, crossOrigin: c, onClose: b } = f,
          i = a.useRef(null);
        return (
          a.useEffect(() => {
            let f = (f) => {
          ...
          (0, t.jsxs)("div", {
            ...
            children: [
              ...
              (0, t.jsx)("button", {
                ...
                onClick: b,
                children: (0, t.jsx)(r.In, {
                  icon: "close",
                  className: (0, o.P)("size-5"),
                }),
              }),
            ],
          })
      ...
      function p(f, e) {
        if (document.startViewTransition)
          try {
            ...
            if (
              d instanceof Error &&
              ("AbortError" === d.name || "InvalidStateError" === d.name)
            ) {
              f(), null == e || e();
              return;
            }
      ...
      let n = JSON.parse(
        ...
        b = r.forwardRef(function (f, e) {
          let d = (0, c.useIcons)(),
            ...
            [l, u] = (function (f, e) {
              var d, t;
              let r = null == (d = a.get(e)) ? void 0 : d.get(f);
              if (r) return r;
              let c = [f, e];
              ...
              return (
                ...
                null == (t = a.get(e)) || t.set(f, c),
                c
              );
            })(b, r),
            p = (0, c.getIconAssetURL)(d, l, u);
          return (0,
          t.jsx)("svg", { ref: e, ...s, style: { maskImage: "url(".concat(p, ")"), WebkitMaskImage: "url(".concat(p, ")"), maskRepeat: "no-repeat", WebkitMaskRepeat: "no-repeat", maskPosition: "center", WebkitMaskPosition: "center", ...(i ? { width: i, height: i } : {}), ...s.style }, className: "gb-icon ".concat(o) });
        });
    },
    62442: (f, e, d) => {
      "use strict";
      ...
      var t = d(54568),
        r = d(7620);
      let c = r.createContext({ hash: null, updateHashFromUrl: () => {} });
      function n() {
      ...
      let a = (f) => {
        let { children: e } = f,
          [d, a] = r.useState(n),
          b = r.useCallback((f) => {
            a(new URL(f, window.location.origin).hash.slice(1));
          }, []),
          o = r.useMemo(() => ({ hash: d, updateHashFromUrl: b }), [d, b]);
        return (0, t.jsx)(c.Provider, { value: o, children: e });
      };
      function b() {
        let { hash: f } = r.useContext(c);
        return f;
      }
    },
    62574: (f, e, d) => {
      "use strict";
      d.d(e, {
        G8: () => s.CurrentPageProvider,
        GK: () => n.HashContext,
        MR: () => n.HashProvider,
        uT: () => i.useCurrentContent,
        aP: () => s.useCurrentPage,
        Zq: () => o.useCurrentPagePath,
        QZ: () => n.useHash,
        aq: () => a,
        cB: () => l.useNow,
        W1: () => r,
        eb: () => c.useScrollPage,
        E6: () => b.useToggleAnimation,
      });
      var t = d(7620);
      function r(f) {
        let {
              ...
              (f) => {
                f.forEach((f) => {
                  ...
                  e &&
                    a.current.set(
                      e,
                      f.isIntersecting && f.intersectionRatio >= d
                    );
                });
                let e = Array.from(a.current.entries()).find((f) => {
                  let [, e] = f;
                  return e;
                });
                e && n(e[0]);
              },
              { rootMargin: e, threshold: d }
            );
            return (
              f.forEach((f) => {
                try {
                  ...
                  console.error("Failed to observe section", f);
                }
              }),
              () => {
                c.disconnect();
    ...
    63644: (f, e, d) => {
      ...
      let n = r.createContext(void 0),
        a = c.v((f) => ({
          ...
          addPage: (e) =>
            f((f) => {
              let d = f.pages[f.pages.length - 1];
              return d && d.spaceId === e.spaceId && d.pageId === e.pageId
                ? { pages: f.pages }
                : { pages: [...f.pages, e] };
            }),
        }));
      function b(f) {
        let { page: e, children: d } = f,
          b = c.P(a, (f) => f.addPage),
          o = r.useMemo(
            () => (e ? { spaceId: e.spaceId, pageId: e.pageId } : null),
            [e]
          );
        return (
          r.useEffect(() => {
          ...
          (0, t.jsx)(n.Provider, { value: o, children: d })
        );
      }
      function o() {
        let f = r.useContext(n),
          e = c.P(a, (f) => f.pages[f.pages.length - 1]);
        return void 0 !== f ? f : null != e ? e : null;
      }
      function i() {
        return c.P(a, (f) => f.pages);
      }
    },
    65498: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { useToggleAnimation: () => o });
      var t = d(95024),
        r = d(80906),
        c = d(7620);
      let n = { opacity: 1, height: "auto", display: "block" },
        a = { opacity: 0, height: 0, transitionEnd: { display: "none" } },
        b = (0, t.y)(0.02, { ease: (f) => f ** 2 });
      function o(f) {
        let [e, d] = (0, r.l)(),
          t = c.useRef(void 0);
        (0, c.useLayoutEffect)(() => {
        ...
        return (
          c.useEffect(() => {
            if (void 0 !== o && o !== f)
              try {
                d(e.current, f ? n : a, { duration: 0.1 });
                let t = "& > ul > li";
                f ? d(t, { opacity: 1 }, { delay: b }) : d(t, { opacity: 0 });
              } catch (f) {
                console.error(f);
              }
          }, [o, f, d, e]),
          { show: n, hide: a, scope: e }
        );
      }
    },
    65837: (f, e, d) => {
      "use strict";
      d.d(e, { VY: () => r, h3: () => c, tj: () => t });
      let t = [
          "button",
          "group/button",
          "inline-flex",
    ...
    69804: (f, e, d) => {
      ...
      d.r(e),
        d.d(e, {
          OpenAPIOperationContextProvider: () => a,
          useOpenAPIOperationContext: () => b,
        });
      var t = d(54568),
        r = d(7620),
        c = d(60357),
        n = (0, r.createContext)({ onOpenClient: function () {} });
      function a(f) {
        var e = f.children,
          d = (0, c.DK)(function (e) {
            var d;
            null == (d = f.onOpenClient) || d.call(f, e);
          }),
          a = (0, r.useMemo)(
            function () {
              return { onOpenClient: d };
            },
            [d]
          );
        return (0, t.jsx)(n.Provider, { value: a, children: e });
      }
      function b() {
    ...
    76169: (f, e, d) => {
      ...
      function u(f) {
        var e, d, c, l;
        let { announcement: u, contentRef: h } = f,
          g = (0, r.ok)(),
          v = u.link && (null == h ? void 0 : h.href),
          x = "danger" !== u.style,
          y = v ? i.N_ : "div",
          w = m[u.style];
        return (0, t.jsx)("div", {
          ...
          children: (0, t.jsx)("div", {
            className:
              "transition-all duration-300 lg:chat-open:pr-80 xl:chat-open:pr-96",
            children: (0, t.jsxs)("div", {
              className: (0, n.P)("relative", o.yx),
              children: [
                (0, t.jsxs)(y, {
                  href: null != (l = null == h ? void 0 : h.href) ? l : "",
                  className: (0, n.P)(
                  ...
                  children: [
                    (0, t.jsx)(b.In, {
                      icon: w.icon,
                      className: "mt-0.5 mr-3 size-4 shrink-0 ".concat(
                        w.iconColor
                      ),
                    }),
                    (0, t.jsxs)("div", {
                      children: [
                        ...
                        v
                          ? (0, t.jsxs)("div", {
                              className: (0, n.P)(s.h3, w.link, "ml-1 inline"),
                              children: [
                                (null == h ? void 0 : h.icon)
                                  ? (0, t.jsx)("span", {
                                      className: "mr-1 ml-2 *:inline",
                                      children: null == h ? void 0 : h.icon,
                                    })
                                  : null,
                                (null == (e = u.link) ? void 0 : e.title) &&
                                  (0, t.jsx)("span", {
                                    className: "mr-1",
                                    children:
                                      null == (d = u.link) ? void 0 : d.title,
                                  }),
                                (0, t.jsx)(b.In, {
                                  icon:
                                    (null == (c = u.link)
                                      ...
                                      ? "arrow-up-right"
                                      : "chevron-right",
                                  className: (0, n.P)("mb-0.5 inline size-3"),
                                }),
                              ],
                            })
                          : null,
                ...
                x
                  ? (0, t.jsx)(i.$n, {
                      iconOnly: !0,
                      icon: "close",
                      label: (0, r.si)(g, "close"),
                      variant: "blank",
                      size: "default",
                      onClick: p,
                      className:
                        "absolute top-0 right-4 mt-2 mr-2 circular-corners:rounded-lg rounded-sm straight-corners:rounded-none p-1.5 transition-all hover:ring-1 sm:right-6 md:right-8 ".concat(
                          w.close
                        ),
                    })
                  : null,
      ...
      function p() {
        (0, c.AP)(l.Q1, { visible: !1, at: Date.now() }),
          document.documentElement.classList.add(l.NU);
      }
      let m = {
        info: {
    ...
    81608: (f, e, d) => {
      "use strict";
      d.r(e),
        d.d(e, { CurrentContentProvider: () => a, useCurrentContent: () => n });
      var t = d(54568),
        r = d(7620);
      let c = r.createContext(null);
      function n() {
        let f = r.useContext(c);
        if (!f)
          throw Error(
      ...
      function a(f) {
        let e = r.useMemo(
          () => ({
            ...
            siteId: f.siteId,
            siteSectionId: f.siteSectionId,
            siteSpaceId: f.siteSpaceId,
            siteShareKey: f.siteShareKey,
            spaceId: f.spaceId,
            revisionId: f.revisionId,
            visitorAuthClaims: f.visitorAuthClaims,
          }),
          [
            f.organizationId,
            f.siteId,
        ...
        return (0, t.jsx)(c.Provider, { value: e, children: f.children });
      }
    },
    82245: (f, e, d) => {
      "use strict";
      ...
      function n(f) {
        var e, d;
        return (0, t.jsx)(c.bL, {
          openDelay: null != (e = f.openDelay) ? e : 200,
          closeDelay: null != (d = f.closeDelay) ? d : 100,
          ...f,
        });
      }
      function a(f) {
        return (0, t.jsx)(c.l9, { asChild: !0, ...f, children: f.children });
      }
      function b(f) {
        var e;
        let { arrow: d, ...n } = f;
    ...
    85053: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { TrackPageViewEvent: () => n });
      var t = d(7620),
        r = d(62574),
        c = d(14417);
      function n(f) {
        let { displayContext: e } = f,
          d = (0, r.aP)(),
          n = (0, c.useTrackEvent)();
        return (
          t.useEffect(() => {
            ...
            n(
              { type: "page_view" },
              {
                pageId: null != (f = null == d ? void 0 : d.pageId) ? f : null,
                displayContext: e,
              }
            );
          }, [d, n, e]),
    ...
    88118: (f, e, d) => {
      "use strict";
      d.d(e, { ic: () => c, ok: () => n, si: () => r.s, t: () => r.t });
      var t = d(7620),
        r = d(96021);
      let c = t.createContext(null);
      function n() {
        let f = t.useContext(c);
        if (!f)
          throw Error(
            "The hook useLanguage should be wrapped in a <TranslateContext>"
          );
        return f;
      }
    },
    88476: (f, e, d) => {
      "use strict";
      d.d(e, { RootLayoutClientContexts: () => b });
      var t = d(54568),
        r = d(88118),
        c = d(87586),
        n = d(62574),
        a = d(15943);
      function b(f) {
        let { children: e, language: d } = f;
        return (0, t.jsx)(r.ic.Provider, {
          value: d,
          children: (0, t.jsx)(c.Bc, {
            delayDuration: 200,
            children: (0, t.jsx)(n.MR, {
              children: (0, t.jsx)(a.LoadingStateProvider, { children: e }),
            }),
          }),
        });
      }
    ...
    90526: (f, e, d) => {
      ...
      d.d(e, { vV: () => t, yx: () => r });
      let t = 64,
        r = ["px-4", "sm:px-6", "md:px-8", "max-w-screen-2xl", "mx-auto"];
    },
    90862: (f, e, d) => {
      "use strict";
      d.r(e),
      ...
      function o(f) {
        ...
        return (0, t.jsxs)("div", {
          ...
          role: "status",
          "aria-busy": !0,
          className: (0, r.P)("flex", "gap-[25px]", d),
          children: [
            (0, t.jsx)(c.R, {
              tile: 24,
              delay: 0,
              style: ["rounded-md", "aspect-[1/1.2]", "w-full"],
            }),
            (0, t.jsx)(c.R, {
              tile: 24,
              delay: 1,
    ...
    90983: (f, e, d) => {
      ...
      let i = {
        ...
        s = {
          ...
          blank:
            "bg-primary-active disabled:bg-primary-active text-primary-strong font-medium hover:text-primary-strong disabled:text-primary-strong hover:bg-primary-active",
        ...
        l = r.forwardRef((f, e) => {
          let {
            ...
            C = {
              ...
              medium: ["text-sm", v ? "px-2" : "px-3.5", "py-1.5"],
              small: ["text-xs", "py-2", v ? "px-2" : "px-3"],
              xsmall: ["text-xs", "py-1", v ? "px-1.5" : "px-2"],
            },
            P = C[l] || C.default,
            _ = (0, c.P)(i[r], P, y && s[r], u),
            I = (0, b.K)(["ButtonStyles"]),
            ...
            L = d
              ? (0, t.jsx)(a.Link, {
                  ...
                  insights: p,
                  "aria-label": null == h ? void 0 : h.toString(),
                  "aria-pressed": y,
                  target: m,
                  ...j,
                  children: S,
          ...
          return (x || v) && h
            ? (0, t.jsx)(o.Tooltip, {
                rootProps: { open: !0 !== k && void 0 },
                label: h,
                triggerProps: { disabled: k },
                children: L,
              })
            : L;
        }),
        u = r.forwardRef((f, e) => {
          let { children: d, className: r, combinedShape: n = !0, ...a } = f;
          return (0, t.jsx)("div", {
            ref: e,
            className: (0, c.P)(
    ...
    94413: (f, e, d) => {
      "use strict";
      d.r(e), d.d(e, { useCurrentPagePath: () => n });
      var t = d(62942),
        r = d(31417),
        c = d(7620);
      function n() {
        ...
        return (0, c.useMemo)(
          () =>
            (null == f ? void 0 : f.pagePath) && "string" == typeof f.pagePath
              ? (0, r.uv)(decodeURIComponent(f.pagePath))
              : "",
          [null == f ? void 0 : f.pagePath]
        );
      }
    },
    96021: (f, e, d) => {
      ...
      function c(f, e) {
        for (
          var d = arguments.length, c = Array(d > 2 ? d - 2 : 0), n = 2;
          n < d;
          n++
        )
          c[n - 2] = arguments[n];
        let a = f[e];
        if (!a) throw Error('Translation not found for "'.concat(e, '"'));
        let b = [],
          o = a;
        return (c.forEach((f, e) => {
          if ("string" == typeof f) o = o.replace("${".concat(e + 1, "}"), f);
          else {
            let [d, c] = o.split("${".concat(e + 1, "}"));
            b.push(
              (0, t.jsx)(r.Fragment, { children: d }, "string-".concat(e))
            ),
              b.push((0, t.jsx)(r.Fragment, { children: f }, "arg-".concat(e))),
              (o = c);
          }
        }),
        b.length)
          ? (0, t.jsxs)(t.Fragment, { children: [b, o] })
          : o;
      }
      function n(f, e) {
        for (
          var d = arguments.length, t = Array(d > 2 ? d - 2 : 0), r = 2;
          r < d;
          r++
        )
          t[r - 2] = arguments[r];
        return (function f(e) {
          ...
          if ("object" == typeof e && "props" in e)
            return e.props.children.map(f).join("");
          throw Error("Unsupported type ".concat(typeof e));
        })(c(f, e, ...t));
      }
    },
    98743: (f, e, d) => {
